/**   
* @Title: VisitsInfoBean.java 
* @Package com.jw.base.framework.core.clickstream 
* @Description: TODO(用一句话描述该文件做什么) 
* @author bwliu
* @date 2018年3月23日 上午10:08:22 
* @version V1.0   
*/
package com.jw.base.framework.core.clickstream;
...
日期|作者|类型|内容
:----|:-----|:-----|:-----
2018年3月23日|bwliu|新增|VisitsInfoBean.java新增
*/
public class VisitsInfoBean {
	...
	public String toString() {
		return session + " " + start_time + " " + end_time + " " + entry_page + " " + leave_page + " " + visit_page_num + " " + IP_addr + " " + referal;
	}
}
