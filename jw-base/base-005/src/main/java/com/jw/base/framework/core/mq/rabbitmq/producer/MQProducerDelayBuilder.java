...
日期|作者|类型|内容
:----|:-----|:-----|:-----
2016/11/26|liubowen|新增|MQProducerDelayBuilder.java新增
*/
public class MQProducerDelayBuilder {
	...
	public MQProducerDelayBuilder(ConnectionFactory rabbitConnectionFactory) {
	 ...
	 * @param queue
	 */
	public MessageSender buildMessageDelaySender(String exchange, String routingKey, String queue, String delayExchange, String delayRoutingKey, String delayQueue, long x_expires) throws IOException {
		Connection connection = rabbitConnectionFactory.createConnection();
		// 1 构造template, exchange, routingkey等
		// 客户端使用routing key，在exchange和queue之间建立好绑定关系
		// Channel：消息通道，在客户端的每个连接里，可建立多个channel，每个channel代表一个会话任务。
		buildDelayQueue(exchange, routingKey, queue, delayExchange, delayRoutingKey, delayQueue, connection, x_expires);
