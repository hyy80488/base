...
public class DirectRateListQueryDto extends RequestBaseDto implements java.io.Serializable{
	...
	*/ 
	...
	@DrptField(fieldnm="roomtypId",fielddrpt="房型")
	private Integer roomtypId;
	@DrptField(fieldnm="rateId",fielddrpt="价格")
	private Set<String> rateId;
	public Integer getRoomtypId() {
		return roomtypId;
	}
	public Set<String> getRateId() {
		return rateId;
	}
	public void setRoomtypId(Integer roomtypId) {
		this.roomtypId = roomtypId;
	}
	public void setRateId(Set<String> rateId) {
		this.rateId = rateId;
	}
