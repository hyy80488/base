 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentravel.org/OTA/2003/05}HotelReservationID" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class HotelReservationIDs {
    ...
    protected List<ResHotelReservationID> hotelReservationID;
     ...
     * {@link ResHotelReservationID }
     * 
     * 
     */
    public List<ResHotelReservationID> getHotelReservationID() {
        if (hotelReservationID == null) {
            hotelReservationID = new ArrayList<ResHotelReservationID>();
        }
