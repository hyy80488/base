 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentravel.org/OTA/2003/05}HotelReservation" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "HotelReservations")
public class HotelReservations {

    @XmlElement(name = "HotelReservation", required = true)
    protected List<ResHotelReservation> hotelReservation;
     ...
     * {@link ResHotelReservation }
     * 
     * 
     */
    public List<ResHotelReservation> getHotelReservation() {
        if (hotelReservation == null) {
            hotelReservation = new ArrayList<ResHotelReservation>();
        }
