...
public class MissionRequestDto extends RequestBaseDto implements java.io.Serializable {
	...
	*/ 
	...
	@DrptField(fieldnm = "missionTyp", fielddrpt = "missionTyp")
	private String missionTyp;
	...
	public String getMissionTyp() {
		return missionTyp;
	}

	public void setMissionTyp(String missionTyp) {
		this.missionTyp = missionTyp;
	}
