 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentravel.org/OTA/2003/05}hotelInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "hotelInfos")
public class HotelInfos {

    @XmlElement(required = true)
    protected List<HotelInfoSb> hotelInfo;
     ...
     * 
     */
    public List<HotelInfoSb> getHotelInfo() {
        if (hotelInfo == null) {
            hotelInfo = new ArrayList<HotelInfoSb>();
        }
