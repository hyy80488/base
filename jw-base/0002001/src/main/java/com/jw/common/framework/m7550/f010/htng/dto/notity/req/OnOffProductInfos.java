 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.opentravel.org/OTA/2003/05}OnOffProductInfo" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "OnOffProductInfos")
public class OnOffProductInfos {

    @XmlElement(name = "OnOffProductInfo", required = true)
	...
	public void setOnOffProductInfo(List<OnOffProductInfo> onOffProductInfo) {
		this.onOffProductInfo = onOffProductInfo;
	}
