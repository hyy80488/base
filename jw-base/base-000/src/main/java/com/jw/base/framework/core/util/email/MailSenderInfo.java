...
日期|作者|类型|内容
:----|:-----|:-----|:-----
2016/11/26|liubowen|新增|MailSenderInfo.java新增
 */
public class MailSenderInfo {
	...
	public String getToCopyAddress() {
		return toCopyAddress;
	}

	public void setToCopyAddress(String toCopyAddress) {
		this.toCopyAddress = toCopyAddress;
	}
