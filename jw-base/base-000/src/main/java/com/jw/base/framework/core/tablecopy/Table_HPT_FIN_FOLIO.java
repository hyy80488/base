 ...
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_HPT_FIN_FOLIO{
	private static final String TABLE = "hist_fin_folio";
	private static final String ORI_TABLE = "hpt_fin_folio";
	...
	static{
		...
		CELLS.add(new TableCopyDto("folio_typ",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("business_dt",StandardBasicTypes.DATE));
		
		CELLS.add(new TableCopyDto("folio_dhms",StandardBasicTypes.TIMESTAMP));
		
		CELLS.add(new TableCopyDto("acct_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("aracct_no",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("trn_cnt",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("debit_amt",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("credit_amt",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("check_amt",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("trnsf_room_num",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("trnsf_acct_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("trnsf_page_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("print_nums",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("hist_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("rel_folio_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("ar_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("ar_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("turn_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("credited_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("folio_cmnt",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("folio_memo",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("point",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("realcard_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("print_folio_dt",StandardBasicTypes.DATE));
		...
		CELLS.add(new TableCopyDto("corp_dept_nm",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("demand_guest_nm",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("trnsf_guest_nm",StandardBasicTypes.STRING));
