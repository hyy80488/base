...
/**
 * ## 类说明：
 * 	stat_snap_ar_invctrn_jrnl基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_STAT_SNAP_AR_INVCTRN_JRNL{
	private static final String TABLE = "stat_snap_ar_invctrn_jrnl";
	private static final String ORI_TABLE = "stat_snap_ar_invctrn_jrnl";
	...
	static{
		...
		CELLS.add(new TableCopyDto("invc_tax_seq",StandardBasicTypes.STRING));
