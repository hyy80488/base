 ...
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_STAT_SNAP_ROOM{
	private static final String TABLE = "stat_snap_room";
	private static final String ORI_TABLE = "stat_snap_room";
	...
	static{
		...
		CELLS.add(new TableCopyDto("bedtyp_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("room_stus",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("clean_stus",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("repair_typ",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("start_dt",StandardBasicTypes.DATE));
		
		CELLS.add(new TableCopyDto("end_dt",StandardBasicTypes.DATE));
		
		CELLS.add(new TableCopyDto("complete_dt",StandardBasicTypes.DATE));
		
		CELLS.add(new TableCopyDto("roomcls_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("bed_num",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("fo_room_stus",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("fo_pers",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("smoking_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("handicap_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("pseudo_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("combo_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("meetingroom_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("suit_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("shareable_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("bar_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("area",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("area_units",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("hk_room_stus",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("hk_pers",StandardBasicTypes.INTEGER));
