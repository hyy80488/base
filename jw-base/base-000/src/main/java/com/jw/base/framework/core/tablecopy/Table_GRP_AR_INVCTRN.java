 ...
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_GRP_AR_INVCTRN{
	private static final String TABLE = "hist_ar_invctrn";
	private static final String ORI_TABLE = "grp_ar_invctrn";
	...
	static{
		...
		CELLS.add(new TableCopyDto("invctrn_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("ar_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("invc_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("orgar_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("orginvc_no",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("minvctrn_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("rel_invctrn_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("invctrn_flg",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("frttrn_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("frttrncd_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("frttrn_cd",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("frttrn_drpt",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("frtpost_dt",StandardBasicTypes.DATE));
		
		CELLS.add(new TableCopyDto("frtpost_dhms",StandardBasicTypes.TIMESTAMP));
		
		CELLS.add(new TableCopyDto("acct_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("ccar_no",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("dispute_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("trn_memo",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("invctrn_memo",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("frtccardtyp_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("unit_currency_id",StandardBasicTypes.INTEGER));
