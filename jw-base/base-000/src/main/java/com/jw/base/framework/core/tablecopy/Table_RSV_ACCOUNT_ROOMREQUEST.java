...
/**
 * ## 类说明：
 * 	rsv_account_roomrequest基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_RSV_ACCOUNT_ROOMREQUEST{
	private static final String TABLE = "hist_account_roomrequest";
	private static final String ORI_TABLE = "rsv_account_roomrequest";
	...
	static{
		...
		CELLS.add(new TableCopyDto("roomfeatruetyp_id",StandardBasicTypes.INTEGER));
