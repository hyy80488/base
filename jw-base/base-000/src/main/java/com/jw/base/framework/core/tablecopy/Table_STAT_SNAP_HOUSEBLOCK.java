...
/**
 * ## 类说明：
 * 	stat_snap_houseblock基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_STAT_SNAP_HOUSEBLOCK{
	private static final String TABLE = "stat_snap_houseblock";
	private static final String ORI_TABLE = "stat_snap_houseblock";
	...
	static{
		...
		CELLS.add(new TableCopyDto("block_typ",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("block_key",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("from_tm",StandardBasicTypes.TIMESTAMP));
		
		CELLS.add(new TableCopyDto("to_tm",StandardBasicTypes.TIMESTAMP));
		...
		CELLS.add(new TableCopyDto("grp_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("repair_seq",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("share_stus",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("block_stus",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("block_quant",StandardBasicTypes.INTEGER));
		...
		CELLS.add(new TableCopyDto("male_cnt",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("child_cnt",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("rt_amt",StandardBasicTypes.BIG_DECIMAL));
		...
		CELLS.add(new TableCopyDto("dpt_stus",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("vip_flg",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("day_typ",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("stat_dt",StandardBasicTypes.DATE));

		CELLS.add(new TableCopyDto("stay_typ",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("member_flg",StandardBasicTypes.STRING));
