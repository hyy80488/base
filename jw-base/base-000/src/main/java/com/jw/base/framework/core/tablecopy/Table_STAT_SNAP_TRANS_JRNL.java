...
/**
 * ## 类说明：
 * 	stat_snap_trans_jrnl基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_STAT_SNAP_TRANS_JRNL{
	private static final String TABLE = "stat_snap_trans_jrnl";
	private static final String ORI_TABLE = "stat_snap_trans_jrnl";
	...
	static{
		...
		CELLS.add(new TableCopyDto("pkgfolio_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("tax_seq",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("trndtl_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("trndtl_price",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("trndtl_quant",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("trn_amt",StandardBasicTypes.BIG_DECIMAL));
		...
		CELLS.add(new TableCopyDto("goods_price",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("goodstd_quant",StandardBasicTypes.BIG_DECIMAL));
		...
		CELLS.add(new TableCopyDto("value_typ",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("taxrate_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("trn_seq",StandardBasicTypes.STRING));
