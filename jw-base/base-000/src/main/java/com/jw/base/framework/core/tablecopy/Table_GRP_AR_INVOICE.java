 ...
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_GRP_AR_INVOICE{
	private static final String TABLE = "hist_ar_invoice";
	private static final String ORI_TABLE = "grp_ar_invoice";
	...
	static{
		...
		CELLS.add(new TableCopyDto("org_ar_no",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("invc_stus",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("adj_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("cashier_unit_uid",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("cashier_unit_cd",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("cashier_user_uid",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("cashier_user_cd",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("cashier_user_nm",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("issue_num",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("invc_memo",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("issue_dt",StandardBasicTypes.DATE));
		
		CELLS.add(new TableCopyDto("audit_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("audit_unit_uid",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("audit_unit_cd",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("audit_user_uid",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("audit_user_cd",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("audit_user_nm",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("ledger_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("ledger_typ",StandardBasicTypes.STRING));
