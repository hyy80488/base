...
/**
 * ## 类说明：
 * 	hpt_fin_rounting基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_HPT_FIN_ROUTING{
	private static final String TABLE = "hist_fin_routing";
	private static final String ORI_TABLE = "hpt_fin_routing";
...
CELLS.add(new TableCopyDto("chain_uid",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("routing_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("belong_typ",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("routing_typ",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("to_acct_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("to_guest_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("to_page_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("to_ar_no",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("conf_routing_id",StandardBasicTypes.INTEGER));
