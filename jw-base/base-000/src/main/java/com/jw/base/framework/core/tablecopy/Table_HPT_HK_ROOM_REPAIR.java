...
/**
 * ## 类说明：
 * 	hpt_hk_room_repair基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_HPT_HK_ROOM_REPAIR{
	private static final String TABLE = "hist_hk_room_repair";
	private static final String ORI_TABLE = "hpt_hk_room_repair";
	...
	static{
		...
		CELLS.add(new TableCopyDto("return_sts",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("repairrsn_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("repairrsn_remarks",StandardBasicTypes.STRING));
		
		//CELLS.add(new TableCopyDto("complete_user_id",StandardBasicTypes.INTEGER));
		
		//CELLS.add(new TableCopyDto("complete_usernm",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_remarks",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("hist_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_user_nm",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_unit_uid",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_unit_cd",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_user_uid",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("complete_user_cd",StandardBasicTypes.STRING));
