...
/**
 * ## 类说明：
 * 	grp_fin_base_trncode基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_GRP_FIN_BASE_TRNCODE{
	private static final String TABLE = "grp_fin_base_trncode";
	private static final String ORI_TABLE = "grp_fin_base_trncode";
	...
	static{
		...
		CELLS.add(new TableCopyDto("trndtyp_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("frontuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("aruse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("posuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("advdeposit_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("deposit_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("post_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("check_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("arreceipt_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("revenue_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("nights_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("internal_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("online_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("point_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("rvntrncd_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("adjtrncd_id",StandardBasicTypes.INTEGER));
		...
		CELLS.add(new TableCopyDto("trnctyp_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("plus_flg",StandardBasicTypes.STRING));
		...
		CELLS.add(new TableCopyDto("taxtype_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("psncnt_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("apuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("mcuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("crsuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("loguse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("gfcuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("ebsuse_flg",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("split_flg",StandardBasicTypes.STRING));
