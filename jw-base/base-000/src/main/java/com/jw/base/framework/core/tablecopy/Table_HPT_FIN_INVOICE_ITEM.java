...
/**
 * ## 类说明：
 * 	hpt_fin_invoice_item基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_HPT_FIN_INVOICE_ITEM{
	private static final String TABLE = "hist_fin_invoice_item";
	private static final String ORI_TABLE = "hpt_fin_invoice_item";
	...
	static{
		...
		CELLS.add(new TableCopyDto("finvcchargeitem_id",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("item_spec",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("item_unit",StandardBasicTypes.STRING));
		
		CELLS.add(new TableCopyDto("item_nums",StandardBasicTypes.INTEGER));
		
		CELLS.add(new TableCopyDto("item_unit_price",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("finvc_amt",StandardBasicTypes.BIG_DECIMAL));
		
		CELLS.add(new TableCopyDto("tax_rate",StandardBasicTypes.BIG_DECIMAL));
