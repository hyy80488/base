...
/**
 * ## 类说明：
 * 	hpt_fin_rounting_dtl基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_HPT_FIN_ROUTING_DTL{
	private static final String TABLE = "hist_fin_routing_dtl";
	private static final String ORI_TABLE = "hpt_fin_routing_dtl";
