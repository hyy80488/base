...
/**
 * ## 类说明：
 * 	grp_fin_unit_trncode基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_GRP_FIN_UNIT_TRNCODE{
	private static final String TABLE = "grp_fin_unit_trncode";
	private static final String ORI_TABLE = "grp_fin_unit_trncode";
