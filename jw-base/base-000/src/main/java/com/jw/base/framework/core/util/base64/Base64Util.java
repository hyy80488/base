...
日期|作者|类型|内容
:----|:-----|:-----|:-----
2016/11/26|liubowen|新增|Base64Util.java新增
 */
public class Base64Util {
	...
	public static void main(String[] args) {
		System.out.println(Base64Util.decode("YWRtaW4sMQ=="));
		System.out.println(Base64Util.encode("admin,1"));
		System.out.println(Base64Util.encode("ADMIN,jw9897"));
		System.out.println(Base64Util.encode("1"));
		try {
			System.out.println(StringUtil.encryptSha256("1"));
			System.out.println(StringUtil.encryptSha256("jw9897"));
			System.out.println(StringUtil.encryptSha256("nimda9897"));
