...
/**
 * ## 类说明：
 * 	rsv_account_accessory基础字段
 * @author    [jianana]   
 * @version   [V1.0, 2017-02-20]
 * @package com.jw.base.framework.core.tablecopy
 */
public class Table_RSV_ACCOUNT_ACCESSORY{
	private static final String TABLE = "hist_account_accessory";
	private static final String ORI_TABLE = "rsv_account_accessory";
	...
	static{
		...
		CELLS.add(new TableCopyDto("acce_typ",StandardBasicTypes.STRING));
