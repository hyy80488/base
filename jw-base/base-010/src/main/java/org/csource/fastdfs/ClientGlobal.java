	...
	public static void init(String conf_filename) throws FileNotFoundException, IOException, MyException
	{
		...
		String[] parts;
  		...
  		iniReader = new IniFileReader(conf_filename);
			...
			g_connect_timeout = iniReader.getIntValue("dfs.connect_timeout", DEFAULT_CONNECT_TIMEOUT);
  		...
  		g_network_timeout = iniReader.getIntValue("dfs.network_timeout", DEFAULT_NETWORK_TIMEOUT);
  		...
  		g_charset = iniReader.getStrValue("dfs.charset");
  		if (g_charset == null || g_charset.length() == 0)
  		{
  			g_charset = "ISO8859-1";
  		}
  		
  		szTrackerServers = iniReader.getValues("dfs.tracker_server");
