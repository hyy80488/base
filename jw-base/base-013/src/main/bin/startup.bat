...
rem set conf_dir=%ENV_PATH%\..\conf

set conf_dir=D:\_git\jw-source\jw-base\base-013\target\classes
set canal_conf=%conf_dir%\canal.properties
set logback_configurationFile=%conf_dir%\logback.xml

set CLASSPATH=%conf_dir%
rem set CLASSPATH=%conf_dir%\..\lib\*;%CLASSPATH%
set CLASSPATH=D:\_git\jw-source\jw-base\base-013\target\lib\*;%CLASSPATH%
