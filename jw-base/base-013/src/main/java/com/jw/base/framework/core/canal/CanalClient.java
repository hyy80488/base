package com.jw.base.framework.core.canal;
...
public class CanalClient {
	...
	public static void main(String args[]) {
		...
		// 创建链接  
		CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress("192.168.18.201", 11111), "example", "canal", "canal");
		int batchSize = 1000;
		int emptyCount = 0;
		try {
			connector.connect();
