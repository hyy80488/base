...
public class JRHibernateQueryExecuter extends JRAbstractQueryExecuter
{
	...
	static
	{
		...
		hibernateTypeMap.put(Boolean.class, new BooleanType());
		hibernateTypeMap.put(Byte.class, new ByteType());
		hibernateTypeMap.put(Double.class, new DoubleType());
		hibernateTypeMap.put(Float.class, new FloatType());
		hibernateTypeMap.put(Integer.class, new IntegerType());
		hibernateTypeMap.put(Long.class, new LongType());
		hibernateTypeMap.put(Short.class, new ShortType());
		hibernateTypeMap.put(java.math.BigDecimal.class, new BigDecimalType());
		hibernateTypeMap.put(java.math.BigInteger.class, new BigIntegerType());
		hibernateTypeMap.put(Character.class, new CharacterType());
		hibernateTypeMap.put(String.class, new StringType());
		hibernateTypeMap.put(java.util.Date.class, new DateType());
		hibernateTypeMap.put(java.sql.Timestamp.class, new TimestampType());
		hibernateTypeMap.put(java.sql.Time.class, new TimeType());
	}
