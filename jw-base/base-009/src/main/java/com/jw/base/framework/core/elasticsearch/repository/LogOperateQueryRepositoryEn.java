 ...
 */
public interface LogOperateQueryRepositoryEn extends Repository<LogOperateDomainEn, Long> {

	@Query("{\"bool\": {\"must\": [{\"term\": {\"chainUid\": \"?0\"}},{\"term\":{\"unitUid\": \"?1\"}}]}}")
    Page<LogOperateDomainEn> findByChainUidAndUnitUid(String chainuid, String unituid, Pageable pageable);
}
