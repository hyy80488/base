...
import com.jw.base.framework.core.elasticsearch.domain.LogOperateDomainZh;
 ...
 */
public interface LogOperateQueryRepositoryZh extends Repository<LogOperateDomainZh, Long> {

	@Query("{\"bool\": {\"must\": [{\"term\": {\"chainUid\": \"?0\"}},{\"term\":{\"unitUid\": \"?1\"}}]}}")
    Page<LogOperateDomainZh> findByChainUidAndUnitUid(String chainuid, String unituid, Pageable pageable);
}
