...
*/
@Component("shardedJedisImpl")
public class JwCacheShardedJedisImpl implements JwCache {

	private static ShardedJedis jc;
	...
	private static void init(){
		...
		int port = Integer.valueOf((String) PropertyConfigurer.getContextProperty("redisSentinel.port"));
		...
		RedisSentinel redisSentinelJedisPool = new RedisSentinelShardedJedisPool(host, port, serverName);
		jc = (ShardedJedis) redisSentinelJedisPool.getResource();
		System.out.println("初始化JwCacheShardedJedisImpl......");
	}
	/**
	 * ## 方法说明：
	 * 	设置单体 Byte
	...
	public <T> String setObj(String key, T value) {
		return jc.set(key.getBytes(Charset.forName("utf-8")), TSerUtils.serial(value));
	}
	...
	public <T> T getObj(String key) {
		T value = null;
		byte[] values = jc.get(key.getBytes(Charset.forName("utf-8")));
...
//		return jc.sdiff(keys);
	...
	public long sdiffstore(String newkey, String... keys) {
		// TODO Auto-generated method stub
//		return jc.sdiffstore(newkey, keys);
		return 0;
	}
...
//		return jc.sinter(keys);
	...
	public long sinterstore(String newkey, String... keys) {
		// TODO Auto-generated method stub
//		return jc.sinterstore(newkey, keys);
		return 0;
	}
...
//		return jc.sunion(keys);
	...
	public long sunionstore(String newkey, String... keys) {
		// TODO Auto-generated method stub
//		return jc.sunionstore(newkey, keys);
		return 0;
	}
	...
	public long hset(String key, String fieid, String value) {
		return jc.hset(key, fieid, value);
	}
	...
	public long hsetnx(String key, String fieid, String value) {
		return jc.hsetnx(key, fieid, value);
	}
	...
	public long hincrby(String key, String fieid, long value) {
		return jc.hincrBy(key, fieid, value);
	}
